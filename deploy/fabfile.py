...
env.project_name = ''
env.repo_path = ''
env.project_paths = {'root': 'PATH HERE'}
env.user = ''
env.git_branch = 'master'

NGINX = NginxServer('nginx', sites=['SITE NAME', 'SITE NAME']) # Site name should be the name of the config file
APACHE = ApacheServer('apache', sites=['SITE NAME']) # Site name should be the name of the config file

# If using Celery then uncomment the next two lines
# RABBITMQ = RabbitServer('rabbitmq')
# CELERY = CeleryServer('celery')


machines = Machines({
    #Dev
    'localhost': {'env_name': 'dev', 'servers': [], 'python_version': '2.5'},
    #Staging
#    'slice4.geniusrocket.com': {'port': '9123', 'env_name': 'staging', 'servers': [NGINX, APACHE], 'python_version': '2.5'},
#   'utils.grskylab.com': {'port': '9123', 'env_name': 'staging', 'servers': [RABBITMQ, CELERY], 'python_version': '2.6'},
    #Production
#    'slice9.geniusrocket.com': {'port': '9123', 'env_name': 'production', 'servers': [NGINX, APACHE], 'python_version': '2.5'},
#   'utils.geniusrocket.com': {'port': '9123', 'env_name': 'production', 'servers': [RABBITMQ, CELERY], 'python_version': '2.6'},
})
...
# This runs after all the individual server configs to handle 
# global settings
